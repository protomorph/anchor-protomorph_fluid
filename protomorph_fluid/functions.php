...
function twitter_account() {
	return site_meta('twitter', $GLOBALS['fluid']['twitter_user']);
}
...
function article_pager() {
	if(article_previous_url() || article_next_url()) {
		if(article_previous_url()) {
			$article_previous = '<li class="previous"><a href="' . article_previous_url() . '">' . $GLOBALS['fluid']['article_prev'] . '</a></li>';
		} else {
			$article_previous = false;
		}

		if(article_next_url()) {
			$article_next_url = '<li class="next"><a href="' . article_next_url() . '">' . $GLOBALS['fluid']['article_next'] . '</a></li>';
		} else {
