...
<body class="<?php echo body_class(); ?>">
	...
	<nav class="navbar" role="navigation">
		<div class="inner">
			<div class="head">
				<button class="toggle" type="button" data-toggle="collapse">
					<span class="bar"></span>
					<span class="bar"></span>
					<span class="bar"></span>
				</button>
			...
			<div class="collapse">
				...
				<ul class="navlinks navlinks-right" role="menu">
					<li class="dropdown">
	...
	<header class="header">
		<div class="inner">
			...
			<form class="search" id="search" action="<?php echo search_url(); ?>" method="post" role="search">
				<input class="float-input" id="term" type="search" name="term" placeholder="Search" value="<?php echo search_term(); ?>">
